...
public class DBClassTest_01 {
    ...
    public void setUp() throws Exception {
        ...
        if (doCount > 0) {
            ...
            DataModel a = new DataModel(0f, 20.0f, 20.0f, -4.0f, 1, "defaultball1");
            DBtest.save(a);
            a = new DataModel(0f, 30f, 30f, 3f, -1, "defaultball2");
            DBtest.save(a);
        }
...
//        DataModel newBall = new DataModel(0f, 5.0f, 5.0f, 5.0f, 50000, "defaultball");
//        DBtest.save(newBall);
//
